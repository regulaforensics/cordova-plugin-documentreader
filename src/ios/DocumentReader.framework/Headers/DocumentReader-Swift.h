...
SWIFT_MODULE_NAMESPACE_PUSH("DocumentReader")
@class NSCoder;
...
@property (nonatomic, readonly) CGFloat lineWidthValue;
@property (nonatomic, readonly) CGFloat oneSizeValue;
@property (nonatomic, readonly) CGFloat lineOffset;
@property (nonatomic, readonly) CGFloat startScaleMultiplier;
- (nonnull instancetype)initWithCenterPoint:(CGPoint)centerPoint OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)prepareLayerWithCenterPoint:(CGPoint)centerPoint;
- (CGPathRef _Nonnull)calculatePathWithSize:(CGFloat)size centerPoint:(CGPoint)centerPoint SWIFT_WARN_UNUSED_RESULT;
- (void)animationStartWithCenterPoint:(CGPoint)centerPoint;
- (CABasicAnimation * _Nonnull)opacityAnimation SWIFT_WARN_UNUSED_RESULT;
- (CABasicAnimation * _Nonnull)scaleAnimationWithCenterPoint:(CGPoint)centerPoint SWIFT_WARN_UNUSED_RESULT;
...
@interface CIImage (SWIFT_EXTENSION(DocumentReader))
@property (nonatomic, readonly, strong) UIImage * _Nullable image;
@end

@class AVCapturePhotoSettings;

SWIFT_CLASS("_TtC14DocumentReader29CamManualPhotoCaptureDelegate")
@interface CamManualPhotoCaptureDelegate : NSObject
@property (nonatomic, readonly, strong) AVCapturePhotoSettings * _Nonnull requestedPhotoSettings;
@property (nonatomic, readonly, copy) void (^ _Nonnull willCapturePhotoAnimation)(void);
@property (nonatomic, readonly, copy) void (^ _Nonnull completionBlock)(CamManualPhotoCaptureDelegate * _Nonnull, UIImage * _Nullable);
@property (nonatomic, copy) NSData * _Nullable jpegPhotoData;
- (nonnull instancetype)initWithPhotoSettings:(AVCapturePhotoSettings * _Nonnull)photoSettings photoAnimation:(void (^ _Nonnull)(void))photoAnimation completion:(void (^ _Nonnull)(CamManualPhotoCaptureDelegate * _Nonnull, UIImage * _Nullable))completion OBJC_DESIGNATED_INITIALIZER;
- (void)didFinishWithImage:(UIImage * _Nullable)image;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC14DocumentReader10FilterView")
@interface FilterView : UIView
@property (nonatomic, strong) CAGradientLayer * _Nonnull filter;
...
SWIFT_CLASS("_TtC14DocumentReader16CustomFilterView")
@interface CustomFilterView : FilterView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


@interface AVCaptureDeviceDiscoverySession (SWIFT_EXTENSION(DocumentReader))
...
- (BOOL)initializeReaderWithLicense:(NSData * _Nonnull)license error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
@interface DocReader (SWIFT_EXTENSION(DocumentReader))
- (BOOL)didMotionControlEnabledWithCameraViewController:(DocumentReaderCameraViewController * _Nonnull)cameraViewController SWIFT_WARN_UNUSED_RESULT;
- (BOOL)showCameraViewControllerCaptureButtonWithCameraViewController:(DocumentReaderCameraViewController * _Nonnull)cameraViewController SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, copy) NSArray<NSLayoutConstraint *> * _Nonnull portraitConstraints;
@property (nonatomic, copy) NSArray<NSLayoutConstraint *> * _Nonnull landscapeRightConstraints;
@property (nonatomic, copy) NSArray<NSLayoutConstraint *> * _Nonnull landscapeLeftConstraints;
@property (nonatomic, strong) UIButton * _Null_unspecified closeButton;
@property (nonatomic, strong) UIButton * _Null_unspecified flashButton;
@property (nonatomic, strong) UILabel * _Null_unspecified statusLabel;
@property (nonatomic, strong) UIButton * _Null_unspecified captureButton;
@property (nonatomic, strong) UILabel * _Null_unspecified resultStatus;
@property (nonatomic, strong) UIView * _Null_unspecified resultStatusView;
@property (nonatomic, strong) FilterView * _Null_unspecified bottomFilterView;
@property (nonatomic, strong) CustomFilterView * _Null_unspecified customFilterView;
...
@property (nonatomic, copy) NSString * _Nullable cameraStatusString;
@property (nonatomic) BOOL recognitionIsActive;
@property (nonatomic) BOOL showCaptureButton;
@property (nonatomic, readonly) BOOL barcodeEnabled;
@property (nonatomic, readonly) BOOL ocrEnabled;
...
- (UIImage * _Nullable)imageWithName:(NSString * _Nonnull)name renderingMode:(UIImageRenderingMode)renderingMode SWIFT_WARN_UNUSED_RESULT;
- (void)captureButtonTapped:(UIButton * _Nonnull)sender;
- (void)photoScanningIsStarting:(BOOL)starting;
- (IBAction)tappedOnPreview:(UITapGestureRecognizer * _Nonnull)recognizer;
...
- (void)focusWithRatioPoint:(CGPoint)ratioPoint point:(CGPoint)point continuousAuto:(BOOL)continuousAuto automaticMode:(BOOL)automaticMode;
- (void)addFocusLayerWithCenterPoint:(CGPoint)centerPoint automatiMode:(BOOL)automatiMode;
...
@interface DocumentReaderCameraViewController (SWIFT_EXTENSION(DocumentReader))
- (void)updateResultStatusLabelTimer;
- (void)removeResultStatusTimer;
- (void)resetResultStatus;
- (void)changeDefaultStatusWithText:(NSString * _Nonnull)text;
- (void)changeResultStatusWithText:(NSString * _Nonnull)text;
- (void)changeStatusWithLabel:(UILabel * _Nonnull)label text:(NSString * _Nonnull)text;
- (void)hideView:(BOOL)isHidden view:(UIView * _Nonnull)view unhiddenAlpha:(CGFloat)unhiddenAlpha;
@end


@interface DocumentReaderCameraViewController (SWIFT_EXTENSION(DocumentReader))
- (NSDictionary * _Nonnull)photoSettingsDictionary SWIFT_WARN_UNUSED_RESULT;
- (AVCapturePhotoSettings * _Nullable)photoSettings SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=10.0);
...
- (void)makeInternalLogicWithDocumentReaderResult:(DocumentReaderResults * _Nonnull)documentReaderResult imageSize:(CGSize)imageSize;
- (void)updateTargetObjectsTimer;
- (void)removeTargetObjectsTimer;
- (void)targetLayersStatusWithIsHidden:(BOOL)isHidden;
- (void)resetToDefaultPosition;
- (void)setDefaultPositionTargetLayersWithSize:(CGSize)size;
- (void)createDefaultTargetObjects;
- (NSArray<NSValue *> * _Nonnull)defaultTargetLayerPointsWithSize:(CGSize)size SWIFT_WARN_UNUSED_RESULT;
@end
...
- (nonnull instancetype)initWithSourceType:(enum ResultType)sourceType fieldType:(enum GraphicFieldType)fieldType boundRect:(CGRect)boundRect value:(UIImage * _Nonnull)value OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
- (nonnull instancetype)initWithFields:(NSArray<DocumentReaderGraphicField *> * _Nonnull)fields OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
- (nonnull instancetype)initWithResults:(NSArray<DocumentReaderJsonResultGroup *> * _Nonnull)results OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
- (nonnull instancetype)initWithDocumentType:(DocumentReaderDocumentType * _Nullable)documentType textResult:(DocumentReaderTextResult * _Nonnull)textResult graphicResult:(DocumentReaderGraphicResult * _Nonnull)graphicResult jsonResult:(DocumentReaderJsonResult * _Nonnull)jsonResult documentPosition:(DocumentPosition * _Nullable)documentPosition barcodePosition:(BarcodePosition * _Nullable)barcodePosition imageQualityGroup:(ImageQualityGroup * _Nullable)imageQualityGroup overallResult:(enum CheckResult)overallResult OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly) enum CheckResult status;
- (nonnull instancetype)initWithFields:(NSArray<DocumentReaderTextField *> * _Nonnull)fields status:(enum CheckResult)status OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
+ (NSString * _Nonnull)string:(NSString * _Nonnull)string comment:(NSString * _Nonnull)comment SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface NSNumber (SWIFT_EXTENSION(DocumentReader))
...
@property (nonatomic, readonly) CGFloat lineLenght;
@property (nonatomic, copy) NSArray<NSValue *> * _Nonnull pointsArray;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)prepareLayerWithPoint:(CGPoint)point;
- (CGPoint)calculatePointOnLineWithStartPoint:(CGPoint)startPoint endPoint:(CGPoint)endPoint lineLenght:(CGFloat)lineLenght SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithLayer:(id _Nonnull)layer SWIFT_UNAVAILABLE;
@end


@interface UIColor (SWIFT_EXTENSION(DocumentReader))
+ (UIColor * _Nonnull)rgba:(NSInteger)r :(NSInteger)g :(NSInteger)b :(CGFloat)a SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) UIColor * _Nonnull themeColor;)
